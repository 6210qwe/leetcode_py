...
# ============================================================================
"""
核心思想: SQL查询，JOIN和GROUP BY

算法步骤:
1. JOIN Trips和Users表，过滤非禁止用户
2. 按日期分组
3. 计算取消率：取消订单数/总订单数
...
Solution = create_solution(trips_and_users)
