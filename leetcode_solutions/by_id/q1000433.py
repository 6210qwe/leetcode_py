...
# ============================================================================
"""
核心思想: 模拟操作过程，计算最终宝石数量

算法步骤:
1. 按照operations顺序执行赠送操作
2. 每次操作：x给y一半宝石（向下取整）
3. 最后找到最大值和最小值，返回差值
...
def give_gem(gem: List[int], operations: List[List[int]]) -> int:
    """
    函数式接口 - 宝石补给
...
Solution = create_solution(give_gem)
